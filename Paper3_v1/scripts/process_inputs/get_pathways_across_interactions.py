...
def get_performance_across_interactions(df, rohs, outputfile_path):
    ...
    for target_roh in rohs:
        ...
        for interaction in interaction_combinations:
            ...
            mapping_dict = get_sequences(df_subset, outputfile_path, target_roh, interaction)

            get_tipping_points(df_subset, mapping_dict, outputfile_path, target_roh, interaction)
